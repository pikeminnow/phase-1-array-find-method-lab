...
const record2 = [
  ...
  function superbowlWin(element){
     let didTheyWin = element.find(checkScore);
     if(didTheyWin){didTheyWin = didTheyWin.year;}; //this smells inelegant
     return didTheyWin;
    ...
    //else return undefined; (not needed since JS will do this by default)
  }
let com = superbowlWin(record);
